...
Ziel dieser Aufgabe ist die grundlegende Navigation in der Shell zu verstehen.
	\begin{itemize}
		\item[a)] Starten Sie die Kommandozeile (Shell)! Entweder via Tastenkombination \keys{\ctrl + \Alt + t} (STRG + ALT + T) oder über das Menü bzw. das Icon im Panel.\\
		...
		\item[c)] Navigieren Sie via \emph{cd} in den Ordner \path{/var}
