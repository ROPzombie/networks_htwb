...
\textbf{Sie finden die Übungsblätter im Moodle-Kurs, auf den Laborrechnern unter \path{~/share/lehrende/troester/netzwerke/exercises/} und auf den Raspberry Pi unter \path{~/network_exercises/}}\\
...
\item Nutzer \& Gruppen -- Rechte für alle!
  ...
  Weg! \path{\tmp} ist ein rein temporäres Verzeichnis.
\end{enumerate}
